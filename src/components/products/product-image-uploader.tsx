...
import { useFileUpload, type FileWithPreview } from "@/utils/hooks/use-file-upload"
...
export default function ProductImageUploader({ onFilesChange}:  ProductImageUploaderProps) {
  const maxSizeMB = 5
