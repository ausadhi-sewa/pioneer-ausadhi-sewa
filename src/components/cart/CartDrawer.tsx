...
import {type  AuthDialogProps } from '../auth/AuthDialog';

export default function CartDrawer(props: AuthDialogProps) {
    ...
    <>
      ...
      <AuthDialog
       open={authDialogOpen}
        ...
        error={props.error}
        requiresEmailConfirmation={props.requiresEmailConfirmation}
        confirmationEmail={props.confirmationEmail}
        onResendEmail={props.onResendEmail}
        onCloseEmailConfirmation={props.onCloseEmailConfirmation}
      />
    </>
  );
} 