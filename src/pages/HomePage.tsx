...
// import bannerTop from '../assets/banner-top.webp';
...
//                Pioneer Ausadhi Sewa
//               </h1>
//               <p className="text-sm text-gray-700 font-medium leading-tight">MEDICINE DELIVERY</p>
// <p>AusadhiSewa is a modern online pharmacy focused on fast, reliable medicine delivery and a smooth shopping experience. We aim to make healthcare more accessible by combining verified products with helpful information and customer-first support.</p>
...
import type { Product, ProductFilters } from '../api/productApi';
import heroImage from '../assets/hero-removebg-preview.png';
// import bannerTop from '../assets/banner_top.webp';
import ProductCard from '@/components/products/ProductCard';
  ...
  const bannerSlides = [
    {
      ...
      description: "AusadhiSewa is a modern online pharmacy focused on fast, reliable medicine delivery and a smooth shopping experience. We aim to make healthcare more accessible by combining verified products with helpful information and customer-first support.",
      image: heroImage,
      hasButton: false,
    },
    {
